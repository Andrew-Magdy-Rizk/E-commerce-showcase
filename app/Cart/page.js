      ...
      <section className="py-24 min-h-[100vh] relative dark:bg-gray-900">
        <div className="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto">
          ...
          <div className="max-lg:max-w-lg max-lg:mx-auto">
            ...
            <button className="block rounded-full py-4 px-6 bg-primary text-black hover:text-white font-semibold text-lg w-full text-center transition-all duration-500 hover:bg-secondary">
              Checkout
            </button>
          </div>
        </div>
